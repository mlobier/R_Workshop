...
You have run the following experiment and acquired a bunch of behavioral data. All this nice data now needs to be analyzed.
...
The data is located in  E:\attentionPerception\_2017AlphaSynchAttention\data\behav. 
